...
export const projectAPI = {
  ...
  updateMilestone: (id, data) => request.patch(`/projects/${id}/milestones/`, data),
  deleteMilestone: (id, milestoneId) => request.delete(`/projects/${id}/milestones/`, { data: { milestone_id: milestoneId } }),
