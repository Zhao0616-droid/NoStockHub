...
| ---- | ---- | ---- | ------------ | ---- | -------- |
|软件2403|U202417380|赵嘉诚|Zhao0616-droid| 组长 | 系统设计 + 后端看板/冲刺/文件/报表 + 数据库 + 测试部署 |
|软件2403|U202417375|王子琪|Liliz226| 组员 | 需求分析 + 前端架构/Layout + 认证与路由 |
|软件2403|U202417370|路昊天|lht622| 组员 | 前端仪表盘 + 项目页 + 公共组件 |
|软件2403|U202417382|周硕|hhh0164| 组员 | 后端任务 + 工时模块 |
|软件2403|U202417369|刘经纬|lg997| 组员 | 后端认证 + 通知 + 数据库 |
|软件2403|U202417374|王恒|beadeepr| 组员 | 后端架构 + 项目模块 + 公共基类 |
|软件2403|U202417373|万晶宇|wan-jingyu| 组员 | 前端甘特图/看板/任务列表 + 图表组件 |
|软件2403|U202415693|胡博涵|HebIhe| 组员 | 前端冲刺/报表页 + 部署测试 |
